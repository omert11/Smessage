...
import kotlinx.android.synthetic.main.teksatir_arkadas.view.*

class ArkadasRec(var arkadaslar: ArrayList<arkadasdata>,val Contex:Context, val itemClickListener: (String,String) -> Unit) : RecyclerView.Adapter<ArkadasRec.ArkadasViewHolder>() {
